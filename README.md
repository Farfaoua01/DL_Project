...
Le projet est réalisé dans le cadre du module Deep Learning (2025/2026).

---

## Objectifs du projet
- Utiliser **DenseNet121** via *Transfer Learning*
- Préparer & nettoyer un dataset IRM
- Entraîner un modèle robuste
- Évaluer les performances avec des métriques standard
